...
#define APDS9960_SCL_Pin GPIO_PIN_13
#define APDS9960_SCL_GPIO_Port GPIOB
#define APDS9960_SDA_Pin GPIO_PIN_15
#define APDS9960_SDA_GPIO_Port GPIOB
#define APDS9960_INT_Pin GPIO_PIN_12
#define APDS9960_INT_GPIO_Port GPIOB

#define APDS9960_SCL_H() HAL_GPIO_WritePin(GPIOB, APDS9960_SCL_Pin, GPIO_PIN_SET)
#define APDS9960_SCL_L() HAL_GPIO_WritePin(GPIOB, APDS9960_SCL_Pin, GPIO_PIN_RESET)

#define APDS9960_SDA_H() HAL_GPIO_WritePin(GPIOB, APDS9960_SDA_Pin, GPIO_PIN_SET)
#define APDS9960_SDA_L() HAL_GPIO_WritePin(GPIOB, APDS9960_SDA_Pin, GPIO_PIN_RESET)

#define APDS9960_IN_SDA() HAL_GPIO_ReadPin(GPIOB, APDS9960_SDA_Pin)
...
u8 setAmbientLightGain(uint8_t gain);
uint8_t getProximityGain(void);
u8 setProximityGain(uint8_t gain);
...
/* Clear interrupts */
u8 clearAmbientLightInt(void);
u8 clearProximityInt(void);
...
/* Gesture methods */
u8 isGestureAvailable(void);
int readGesture(void);

/* Gesture processing */
void resetGestureParameters(void);
u8 processGestureData(void);
u8 decodeGesture(void);
